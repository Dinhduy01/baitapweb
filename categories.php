...
<body>
    ...
    <main>
        <div class="menu-food-1" style="width: 100%;height: 700px;background-color: white;">
            <div class="pizza">
                <a class="menu-food-1 pizza-v" href="">
                    <div class="text-food">Pizza</div>
                    <img class="img-food-s" src="image/menu-pizza.jpg" width="140px" height="140   px" alt="">
                </a>
                <a class="menu-food-1 pizza-v " href="">
                    <div class="text-food">Pizza</div>
                    <img class="img-food-s" src="image/menu-pizza.jpg" width="140px" height="140   px" alt="">
            ...
            <div class="burger">
                <a class="menu-food-1 burger" href="">
                    <div class="text-food">Burger</div>
                    <img class="img-food-s" src="image/menu-burger.jpg" width="140px" height="140   px" alt="">
                </a>
                <a class="menu-food-1 burger" href="">
                    <div class="text-food">Burger</div>
                    <img class="img-food-s" src="image/menu-burger.jpg" width="140px" height="140   px" alt="">
            ...
            <div class="momo">
                <a class="menu-food-1 momo" href="">
                    <div class="text-food">Momo</div>
                    <img class="img-food-s" src="image/menu-momo.jpg" width="140px" height="140   px" alt="">
                </a>
                <a class="menu-food-1 momo" href="">
                    <div class="text-food">Momo</div>
                    <img class="img-food-s" src="image/menu-momo.jpg" width="140px" height="140   px" alt="">
